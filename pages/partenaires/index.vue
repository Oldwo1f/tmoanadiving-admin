...
<div class="panelContainer" :class="{secondary : route.path !=='/partenaires'}">
  ...
  <b-modal id="modalAddPartenaire" ref="closemodal" header-bg-variant="primary"
      header-text-variant="white" centered size="md" title="Ajouter un partenaire"  hide-footer>
      ...
      <ValidationObserver ref="validatorNewPartenaire" class="modalForm"  reset="resetNewPartenaireForm">
        ...
        <form @submit.prevent="submitNewPartenaire">
          ...
          <ValidationProvider class="formElem" rules="required" v-slot="{ errors }">
            <b-input type="text" v-model="formNewPartenaire.name" placeholder="Nom du partenaire" :state="errors.length? false : null" />
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="card-title">
              ...
              <b-btn class="btn-outline btn-primary btn-square leftLastBtn" v-b-modal.modalAddPartenaire  title="Ajouter un Partenaire"> <span class="material-icons">add</span></b-btn>
