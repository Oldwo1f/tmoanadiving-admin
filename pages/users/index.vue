...
<div class="panelContainer" :class="{secondary : route.path !=='/users'}">
  ...
  <b-modal id="modalAddUser" ref="closemodal" header-bg-variant="primary"
      header-text-variant="white" centered size="md" title="Ajouter un utilisateur"  hide-footer>
      ...
      <ValidationObserver ref="validatorNewUser" class="modalForm"  reset="resetNewUserForm">
        ...
        <form @submit.prevent="submitNewUser">
          ...
          <ValidationProvider class="formElem" rules="required|email" v-slot="{ errors }">
            <b-input type="text" v-model="formNewUser.emailAddress" placeholder="Adresse email" :state="errors.length? false : null" />
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="card-title">
              ...
              <b-btn class="btn-outline btn-primary btn-square leftLastBtn" v-b-modal.modalAddUser  title="Ajouter un utilisateur"> <span class="material-icons">person_add</span></b-btn>
