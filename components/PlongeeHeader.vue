<template>
	<div class="col-12">
			<div class="card" v-if="plongee">
				<div class="card-body userHead">
					<div class="left">
						<nuxt-link to="/plongees" >
						<span class="material-icons">
							arrow_back_ios
						</span>
						</nuxt-link>
						<h3 class="card-title ml-2"> {{plongee.name}} </h3>
					...
					<div class="right">
						...
						name="status" storename="plongees" storeproperty="currentPlongee" updateStoreAction="updateCurrentPlongee" />
...
let plongee = ref()
watchEffect(() => {console.log('watchEffect'); plongee.value= state.plongees.currentPlongee;})
console.log('plongee.value.id11',plongee.value.id);

const copyId = async function(){
	console.log('plongee.value.id',plongee.value.id);
