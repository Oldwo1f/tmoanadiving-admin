			...
			<div class="card" v-if="user">
				<div class="card-body userHead">
					...
					<div class="right">
						...
						name="status" storename="administrators" storeproperty="currentAdmin" updateStoreAction="updateCurrentAdmin" />
...
let user = ref()
watchEffect(() => {console.log('watchEffect'); user.value= state.administrators.currentAdmin;
