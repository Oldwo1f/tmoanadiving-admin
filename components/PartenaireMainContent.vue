<template>
	...
	<div class="card">
			...
			<InstantEditor  rules=""  placeholder="Description du partenaire" name="description" storename="partenaires" storeproperty="currentPartenaire" updateStoreAction="updateCurrentPartenaire"/>
			</div>
		</div>
		</div>
</template>
