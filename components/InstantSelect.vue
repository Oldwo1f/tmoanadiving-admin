...
<template>
	...
	<ValidationProvider :rules="rules" v-slot="{ errors }">
		...
		<!-- <b-form-select @input="eventListener(errors)" @blur="updateValue(errors)" @keyup.enter.native="onEnter"  :name="props.name" :state="errors.length? false : null" v-model="model" :placeholder="props.placeholder" ></b-form-input> -->
			<b-form-select  class="mySelect" v-model="model" :options="optionsSelect"  @change="updateValue(errors)" :state="errors.length? false : null " placeholder="choisir la bonne réponse"></b-form-select>
...
const optionsSelect = ref(['A','B','C','D'])
