			...
			<div class="card" v-if="page">
				<div class="card-body userHead">
					<div class="left">
						...
						<h3 class="card-title ml-2"> {{page.name}} </h3>
					...
					<div class="right">
						...
						name="status" storename="pages" storeproperty="currentPage" updateStoreAction="updateCurrentPage" />
...
let page = ref()
watchEffect(() => {console.log('watchEffect'); page.value= state.pages.currentPage;})
console.log('page.value.id11',page.value.id);

const copyId = async function(){
	console.log('page.value.id',page.value.id);
